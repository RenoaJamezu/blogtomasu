  ...
  return (
    <section className="flex bg-primary px-10 h-screen items-center pt-24">
      <div className="flex flex-col gap-5">
        ...
        <p className="font-intertight text-xl text-white">
          A simple, elegant platform for writers and readers. Create, share and discover<br />
          amazing content.
        </p>

        <div className="flex gap-5 mt-5">
          <Link to='/create' className="flex items-center gap-3 text-lg bg-white rounded-lg px-8 py-3 hover:bg-gray-200">
            Start Writing
            <FaArrowRight />
          </Link>
          {!user && (
